...
> 本网站基于 **JokeLin** 的原创门户改造而来 💝

一个粉蓝鹅黄可爱风个人综合门户网站。纯静态实现，托管在 GitHub Pages。

---

## 🌟 致敬 JokeLin

这个门户网站源自 **JokeLin** 的出色原创设计。感谢 JokeLin：

- 💻 **代码才华** — 用纯 HTML + CSS + JavaScript 打造了完整的门户系统
- 🎨 **设计品味** — 暗黑赛博风格的配色与毛玻璃卡片设计
- 🎯 **学术能力** — 聚焦乡村振兴、数字农业的学术研究
- 🤖 **AI 创造力** — AI 音乐、AI 小说、AI 软件工具
- 😄 **幽默感** — 富有个性的标签和有趣的内容
- 🌐 **开源精神** — 将代码开源，让更多人学习和改进

**JokeLin 的个人主页：** [https://jokeslin.github.io/](https://jokeslin.github.io/)
...
- Hero 区打字机标语动画
- 致敬 JokeLin 原创者专区
- 技能卡片、能力标签、工具展示（从 data.json 动态读取）
- 六宫格导航卡片，悬浮动效
- 社交链接：GitHub / Email（从 data.json 动态读取）
...
- 🎀 **粉蓝鹅黄可爱风**（`#fff9f0` 奶油底色）
- 🫧 圆点装饰背景，柔和的毛玻璃卡片
- 💖 粉色 `#ffb5c2`、淡蓝 `#a8d8ea`、鹅黄 `#f7dc6f` 配色
- ✨ 圆角更大（24px/18px），边框更厚（2px）
- 📱 移动端自适应（768px 断点）
- 🎭 所有交互元素 hover 时有弹跳/旋转动画
...
直接访问 [https://deftabc.github.io/zhiyuan.github.io/](https://deftabc.github.io/zhiyuan.github.io/) 即可使用。

## 致谢

再次衷心感谢 **JokeLin** 🎉 创作了这个优秀的门户系统，让我可以在此基础上学习和改造。
